...
const getTotalBalance = users => users.reduce((a, user) => a + user.balance, 0);
...
const getUniqueSkills = users => users.reduce((allSkills, user) => [...allSkills, ...user.skills], []).filter((e, i, a) => i === a.indexOf(e)).sort();
